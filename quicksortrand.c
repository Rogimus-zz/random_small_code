/* a basic implementation of quicksort on integer arrays. This particular 
program chooses a random element of the list to be the wall.
Roger Murray, roger.h.murray@gmail.com, ANU, 
June 2016.
*/
#include <stdlib.h>
#include <stdio.h>
